...
db_path = os.path.join(os.path.dirname(os.path.dirname( __file__ )), "data", "bus_stops.db")
...
geo = figure(title='Christchurch Bus Stops', 
            plot_height=600, 
            plot_width=1000,
...
geo.circle(x='lat_mercator',y='long_mercator', alpha=0.2, source=stops)
